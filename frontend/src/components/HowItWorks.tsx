...
export const HowItWorks: React.FC = () => {
  return (
    <div style={{ marginTop: "2.5rem", paddingTop: "2rem", borderTop: "1px solid var(--border-color, rgba(128, 128, 128, 0.2))" }}>
      ...
      <div style={{ display: "flex", flexWrap: "wrap", gap: "20px", justifyContent: "center" }}>
        {steps.map((step, index) => (
          ...
          >
            ...
            <p style={{ margin: 0, fontSize: "var(--font-size-sm, 0.875rem)", opacity: 0.8, lineHeight: "1.5" }}>
              {step.description}
            </p>
          </div>
        ))}
